<?php
class ModuleContentItem extends DataObject {
    ...
    public function getCMSFields(){
        ...
        $fields->addFieldToTab('Root.Main', CheckboxField::create('NoHeading', 'Disable Title Heading'));
        ...
        $bgcolor2->setDescription("Add this color to make a Gradient Bg");
